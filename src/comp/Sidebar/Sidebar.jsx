import { Box, Flex, Link, AvatarRoot, AvatarFallback, AvatarImage, Button} from "@chakra-ui/react";
        ...
        <Tooltip 
          ...
          >
            ...
            justifyContent={{base:"center", md:"flex-start"}}>
              ...
              <BiLogOut size={25} />
              <Button display={{base:"none", md:"block"}} variant={"ghost"} _hover={{bg: "transparent"}} loading = {isLoggingOut}>
                Logout
              </Button>
            </Flex>
